...
class FlinkProcessBuilder114(
  ...
  override protected def module: String = "kyuubi-flink-sql-engine-1.14"

  override protected def mainClass: String = "org.apache.kyuubi.engine.flink.FlinkSQLEngine114"
