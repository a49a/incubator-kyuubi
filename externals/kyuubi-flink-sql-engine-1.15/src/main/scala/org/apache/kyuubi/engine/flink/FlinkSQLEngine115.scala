...
import org.apache.kyuubi.engine.flink.FlinkSQLEngine115.{countDownLatch, currentEngine}
import org.apache.kyuubi.service.Serverable
import org.apache.kyuubi.util.SignalRegister

case class FlinkSQLEngine115(engineContext: DefaultContext) extends Serverable("FlinkSQLEngine") {
...
object FlinkSQLEngine115 extends Logging {

  val kyuubiConf: KyuubiConf = KyuubiConf()
  var currentEngine: Option[FlinkSQLEngine115] = None
  ...
  def startEngine(engineContext: DefaultContext): Unit = {
    currentEngine = Some(new FlinkSQLEngine115(engineContext))
    currentEngine.foreach { engine =>
