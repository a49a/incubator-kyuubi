...
trait WithFlinkSQLEngine115 extends KyuubiFunSuite {
  ...
  def startFlinkEngine(): Unit = {
    ...
    FlinkSQLEngine115.startEngine(engineContext)
    engine = FlinkSQLEngine115.currentEngine.get
