...
import org.apache.kyuubi.engine.flink.FlinkSQLEngine114.{countDownLatch, currentEngine}
import org.apache.kyuubi.service.Serverable
import org.apache.kyuubi.util.SignalRegister

case class FlinkSQLEngine114(engineContext: DefaultContext) extends Serverable("FlinkSQLEngine") {
...
object FlinkSQLEngine114 extends Logging {

  val kyuubiConf: KyuubiConf = KyuubiConf()
  var currentEngine: Option[FlinkSQLEngine114] = None
  ...
  def startEngine(engineContext: DefaultContext): Unit = {
    currentEngine = Some(new FlinkSQLEngine114(engineContext))
    currentEngine.foreach { engine =>
