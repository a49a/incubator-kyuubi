...
trait WithFlinkSQLEngine114 extends KyuubiFunSuite {
  ...
  def startFlinkEngine(): Unit = {
    ...
    FlinkSQLEngine114.startEngine(engineContext)
    engine = FlinkSQLEngine114.currentEngine.get
